...
object get_logistic_regression_data {
  def main(args: Array[String]): Unit = {
    ...
    for(line <- file.getLines)
    {
      ...
      info_list = split3.mkString(",") +: info_list
    ...
    //文件的写入
    val writer = new PrintWriter(new File("/home/wangtuntun/IJCAI/Data/lr_format_data.txt"))
