...
object Code_test {
  def main(args: Array[String]): Unit = {
    ...
    val map_data=raw_data.map{x=>
      ...
      (split_list(1).toDouble,split_list(2).toDouble,split_list(3).toDouble,split_list(4).toDouble,split_list(5).toDouble,split_list(6).toDouble,split_list(7).toDouble,split_list(8).toDouble,split_list(10).toDouble,split_list(11).toDouble,split_list(12).toDouble)
    }
    val df=sqc.createDataFrame(map_data)
    val data = df.toDF("City_name", "Location_id", "Per_pay", "Score", "Comment_cnt", "Shop_level", "Cate_1_name","Cate_2_name","Month","Day","Flow")
    val colArray = Array("City_name", "Location_id", "Per_pay", "Score", "Comment_cnt", "Shop_level", "Cate_1_name","Cate_2_name","Month","Day")
    ...
    val data_for_predict = df_for_predict.toDF("City_name", "Location_id", "Per_pay", "Score", "Comment_cnt", "Shop_level", "Cate_1_name","Cate_2_name","Month","Day","Flow")
    val colArray_for_predict = Array("City_name", "Location_id", "Per_pay", "Score", "Comment_cnt", "Shop_level", "Cate_1_name","Cate_2_name","Month","Day")
